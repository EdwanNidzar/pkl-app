      ...
      <div class="row">
        <div class="col-lg-6 col-6">
          <div class="small-box bg-info">
            ...
            <div class="icon"><i class="ion ion-stats-bars"></i></div><a href="{{ route('parpols.index') }}"
        ...
        <div class="col-lg-6 col-6">
          <div class="small-box bg-secondary">
            ...
            <div class="icon"><i class="ion ion-stats-bars"></i></div><a href="{{ route('jenispelanggaran.index') }}"
              class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
