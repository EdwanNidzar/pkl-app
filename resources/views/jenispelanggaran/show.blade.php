...
@section('judul_halaman', 'BAWASLU | SHOW DATA JENIS PELANGGARAN')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Show Jenis Pelanggaran</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="jenis_pelanggaran" id="jenis_pelanggaran"
                    placeholder="Jenis Pelanggaran" value="{{ $data->jenis_pelanggaran }}" readonly>
