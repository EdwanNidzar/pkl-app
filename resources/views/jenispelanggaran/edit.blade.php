...
@section('judul_halaman', 'BAWASLU | EDIT DATA JENIS PELANGGARAN')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Edit Jenis Pelanggaran</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form method="POST" action="{{ route('jenispelanggaran.update', $data->id) }}">
              @csrf
              @method('PUT')
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="jenis_pelanggaran" id="jenis_pelanggaran"
                    placeholder="Jenis Pelanggaran" value="{{ old('jenis_pelanggaran', $data->jenis_pelanggaran) }}"
                    autocomplete="off">
